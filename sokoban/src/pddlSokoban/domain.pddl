...
(:predicates 
    ...
    (aVoisinGauche ?x - environnement ?y - environnement)
    (aVoisinBas ?x - environnement ?y - environnement)
    (estDestination ?environnement - environnement)
    (cibleAtteinte ?environnement - environnement)
    (notCibleAtteinte ?environnement - environnement)
...
(:action deplacementGauche
    :parameters (?agent1 - agent ?env1 - environnement ?env2 - environnement)
    :precondition (and (estSur ?agent1 ?env1) (aVoisinGauche ?env1 ?env2) (estLibre ?env2))
    :effect (and (not (estLibre ?env2)) (estLibre ?env1) (not (estSur ?agent1 ?env1)) (estSur ?agent1 ?env2))
)

(:action deplacementBas
    :parameters (?agent1 - agent ?env1 - environnement ?env2 - environnement)
    :precondition (and (estSur ?agent1 ?env1) (aVoisinBas ?env1 ?env2) (estLibre ?env2))
    :effect (and (not (estLibre ?env2)) (estLibre ?env1) (not (estSur ?agent1 ?env1)) (estSur ?agent1 ?env2))
)
...
(:action pousserDroit
    ...
    :effect (and (not (estLibre ?env2)) (not (cibleAtteinte ?env2)) (notCibleAtteinte ?env2) (not (estLibre ?env3)) (estLibre ?env1) (not(estSur ?agent ?env1)) (not(estSur ?boite ?env2)) (estSur ?agent ?env2) (estSur ?boite ?env3))
)
...
(:action pousserGauche
    :parameters (?agent - agent ?boite - boite ?env1 - environnement ?env2 - environnement ?env3 - environnement)
    :precondition (and (estSur ?agent ?env1) (estSur ?boite ?env2) (aVoisinGauche ?env1 ?env2) (aVoisinDroit ?env2 ?env3) (estLibre ?env3))
    :effect (and (not (estLibre ?env2)) (not (cibleAtteinte ?env2)) (notCibleAtteinte ?env2) (not (estLibre ?env3)) (estLibre ?env1) (not(estSur ?agent ?env1)) (not(estSur ?boite ?env2)) (estSur ?agent ?env2) (estSur ?boite ?env3))
)

(:action pousserBas
    :parameters (?agent - agent ?boite - boite ?env1 - environnement ?env2 - environnement ?env3 - environnement)
    :precondition (and (estSur ?agent ?env1) (estSur ?boite ?env2) (aVoisinBas ?env1 ?env2) (aVoisinBas ?env2 ?env3) (estLibre ?env3))
    :effect (and (not (estLibre ?env2)) (not (cibleAtteinte ?env2)) (notCibleAtteinte ?env2) (not (estLibre ?env3)) (estLibre ?env1) (not(estSur ?agent ?env1)) (not(estSur ?boite ?env2)) (estSur ?agent ?env2) (estSur ?boite ?env3))
)
...
(:action marquer
    ...
    :effect (and (cibleAtteinte ?environnement) (not (notCibleAtteinte ?environnement)))
)
)