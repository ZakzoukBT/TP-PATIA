        ...
        try {
            ...
            if (!errorManager.isEmpty()) {
                ...
                for (Action a : problem.getActions()) {
                    ...
                    i++;
                    System.out.print(i + " ");
                    //On doit retraduire ça en une liste d'entiers qui s'effectue à chaque étape de parcours du graphe 
                    //Ensuite on doit lire l'état initial et les changements d'états existants (préconditions et effets) pour les traduire en liste d'entiers
                    //Envoyer ça au SATsolver ensuite !
                }
            }
